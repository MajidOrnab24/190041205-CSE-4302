...
#include <process.h>
using namespace std;
enum Furniture_type {_bed, _diningTable,_sofa};
const int MAX = 100;
class Furniture
{
protected:
...
switch(etype)
{
case _bed: size=sizeof(Bed); break;
case _diningTable: size=sizeof(DiningTable); break;
case _sofa: size=sizeof(Sofa); break;
}
...
cout << "'m' to add a bed"
"\n's' to add a sofa"
"\n'l' to add a dining table"
"\nEnter selection: ";
cin >> ch;
switch(ch)
{
case 'm': arr[n] = new Bed;
break;
case 's': arr[n] = new DiningTable;
break;
case 'l': arr[n] = new Sofa;
break;
...
{
case _bed: cout << ". Type: bed\n";
break;
case _diningTable: cout << ". Type: dining table\n";
break;
case _sofa: cout << ". Type: sofa\n";
break;
